						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									...
									foreach($resultsnew['ReportingList'] as $values){ ?>
									<option value="<?php echo $values['userId']; ?>" <?php if($parentUserId == $values['userId']){ echo "selected";} ?>><?php echo strtoupper($values['userName'])."-".$values['emp_code']."  [".strtoupper($values['roleName'])."]"; ?></option>
							        <?php 
									} 
									?>
									</select>
