					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="email" class="form-control" value="<?php echo $email; ?>" placeholder="Email" name="email"  id="email"  title="xyz@something.com" required>
								</div>
							</div>
							<div class="form-group">
							...
							<?php										
								...
								<label class="control-label col-md-3">Emp Zone</label>
								<div class="col-md-9">
									<select class="form-control" name="zone" id="zone_add"  required>
										<option value="">Select Zone</option>
										<option value="East">East</option>
										<option value="West">West</option>
										<option value="North">North</option>
						...
						<?php 
											...
											$resultsnew = json_decode($results, true) ;
											foreach($resultsnew['StateList'] as $value){
											?>				
						...
						?>			
							...
							<?php										
								...
								<label class="control-label col-md-3">Emp Code</label>
								<div class="col-md-9">
									<input type="text" class="form-control" placeholder="Emp Code" name="code" id="code_add"  placeholder="Enter Employee Code" maxlength="10" required>
								</div>
							</div>
								<?php
							} ?>
...
$("#mobile,#code,#code_add").keydown(function (event) {
...
function fnExceluserReport(){
    ...
    tab_text =tab_text+"<th>Zone</th><th>Emp Code</th><th>Name</th><th>Mobile No</th><th>E-mail_id</th><th>Role</th><th>City</th><th>State</th></tr><tr>";
