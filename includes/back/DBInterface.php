...
class Database
{
    ...
    function connect()
    {
        ...
        $this->dbh = mysql_connect('localhost', 'techteamgl' , 'Tech@321') or die('Not connected');
...
public function chkLogout($username,$passwd){
	...
	function selectReporting($roleId){
		$return_results_top = array();
		$query = "SELECT um.userId,um.emp_code,um.userName,rm.roleName FROM tbl_user_master as um LEFT JOIN tbl_role_master as rm ON um.roleId = rm.roleId LEFT JOIN tbl_user_hierarchy as uh ON um.userId = uh.userId  WHERE rm.roleId < '$role_id' ORDER BY um.userId ASC";
		$sql_query = mysql_query($query, $this->dbh);
	...
	function select_state()
	{
		...
		$ch = curl_init('http://viv3k.in/kentgl_api/admin_select_state.php');
	...
	function select_city($stateid){
		...
		$data_string = json_encode($data);
		$ch = curl_init('http://viv3k.in/kentgl_api/admin_select_city.php');
		curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "POST");
		curl_setopt($ch, CURLOPT_POSTFIELDS, $data_string);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
		curl_setopt($ch, CURLOPT_HTTPHEADER, array(
	...
	function getUserDetails($uid){
		...
		$data_string = json_encode($data);
		$ch = curl_init('http://viv3k.in/kentgl_api/admin_getUserDetails.php');
		curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "POST");
		curl_setopt($ch, CURLOPT_POSTFIELDS, $data_string);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
		curl_setopt($ch, CURLOPT_HTTPHEADER, array(
	...
	function getRoleDetails($role_id){
		...
		$data_string = json_encode($data);
		$ch = curl_init('http://viv3k.in/kentgl_api/admin_getRoleDetails.php');
		curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "POST");
		curl_setopt($ch, CURLOPT_POSTFIELDS, $data_string);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
		curl_setopt($ch, CURLOPT_HTTPHEADER, array(
	...
	function getglList(){
		...
		$data_string = json_encode($data);
		$ch = curl_init('http://viv3k.in/kentgl_api/admin_getgl_list.php');
		curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "POST");
		curl_setopt($ch, CURLOPT_POSTFIELDS, $data_string);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
		curl_setopt($ch, CURLOPT_HTTPHEADER, array(
	...
	function getDistributorList(){
		$data = array("action"=>"gllist");
		$data_string = json_encode($data);
		$ch = curl_init('http://viv3k.in/kentgl_api/admin_getDistributorList.php');
		curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "POST");
		curl_setopt($ch, CURLOPT_POSTFIELDS, $data_string);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
		curl_setopt($ch, CURLOPT_HTTPHEADER, array(
